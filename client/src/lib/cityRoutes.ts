...
export const cityRouteAssets: Record<string, { image: string; imageAlt: string; artifactLabel: string; artifactValue: string }> = {
  ...
  chengdu: { image: "/media/chengdu-street-food-bab634eaa50b.webp", imageAlt: "A busy Chengdu street-food scene at night", artifactLabel: "FIRST-WEEK RITUAL", artifactValue: "One food stop · one return route · one familiar face" },
  hangzhou: { image: "/media/hangzhou-west-lake-b4ed4bf62bc3.jpg", imageAlt: "West Lake in Hangzhou with a lakeside pavilion", artifactLabel: "ARRIVAL POCKET", artifactValue: "Address card · local stop · first campus loop" },
  shenzhen: { image: "/media/shenzhen-electronics-market-d5d9de726e64.jpeg", imageAlt: "Shenzhen electronics market with multilingual shop signs", artifactLabel: "VISIT EVIDENCE", artifactValue: "Sample criteria · floor notes · decision owner" },
  guangzhou: { image: "/media/guangzhou-wholesale-centre-37576b859f9d.jpg", imageAlt: "Guangzhou wholesale centre on a supplier-visit route", artifactLabel: "COMPARISON RECORD", artifactValue: "Supplier · category · next action" },
  yiwu: { image: "/media/yiwu-market-a9c2af296f21.webp", imageAlt: "Yiwu wholesale market aisle with products and buyers", artifactLabel: "RANGE SHORTLIST", artifactValue: "Category · reference · verification question" },
  "shanghai-business": { image: "/media/shanghai-port-handoff-90e3e9a84f06.jpg", imageAlt: "Container port and logistics handoff activity near Shanghai", artifactLabel: "HANDOFF SHEET", artifactValue: "Owner · documents · dated next step" },
};
