...
export default function DesktopFilmTreatment() {
  ...
  return <div className={`desktop-film ${flags.desktopFilmMotion ? "desktop-film--motion" : "desktop-film--still"}`} aria-hidden="true">
    <video ref={videoRef} className="desktop-film__video" muted loop playsInline preload="metadata" poster="https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=1600&q=86"><source src="/media/business-field-reel-402c7eebeb5d.mp4" type="video/mp4" /></video>
